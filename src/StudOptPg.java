...
public class StudOptPg {
	...
	public StudOptPg () {
		...
		frame8.getContentPane().add(panel);
		...
		frame8.getContentPane().add(panel_1);
		...
		frame8.getContentPane().add(panel_2);
