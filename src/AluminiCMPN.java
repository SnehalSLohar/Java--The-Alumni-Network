...
public class AluminiCMPN{
	...
	public AluminiCMPN() {
		...
		JFrame frame9= new JFrame("Alumini List:Computer Engineering");
		frame9.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame9.setBounds(0, 0, 1200, 750);
		...
		frame9.getContentPane().add(panel);
		...
		JLabel lblNewLabel_1 = new JLabel("Alumini List: Computer Engineering");
		...
		frame9.getContentPane().add(DesignPanel);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRowCount()==1) {
					...
					try {
						...
						String sql = "DELETE FROM aluminiinfo_cmpn where id = "+cell;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRowCount()==1)
				{
					...
					try {
						Class.forName("com.mysql.cj.jdbc.Driver");
						Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/miniproject","root","Bappamorya@1133");
						String query="Update aluminiinfo_cmpn set Full_Name='"+name+"',Passout_Year='"+passyr+"',Number='"+phno+"',Email_Id='"+emlid+"' where Full_Name='"+name+"'";
		...
		btnShowData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql="Select * from aluminiinfo_cmpn";
				...
				if(model.getRowCount()==0) {
					...
					try {
						...
						for(int i=0;i<model.getRowCount();i++) {
							...
							String query = "insert into aluminiinfo_cmpn(Full_Name,Passout_Year,Number, Email_Id) values(?,?,?,?)";
		...
		frame9.getContentPane().add(panel_2);
