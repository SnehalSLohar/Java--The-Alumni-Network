...
public class AluminiETRX{
	...
	public AluminiETRX() {
		...
		JFrame frame12= new JFrame("Alumini List:Electrical Engineering");
		frame12.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame12.setBounds(0, 0, 1200, 750);
		frame12.setIconImage(image.getImage());
		...
		frame12.getContentPane().add(panel);
		...
		JLabel lblNewLabel_1 = new JLabel("Alumini List: Electrical Engineering");
		...
		frame12.getContentPane().add(DesignPanel);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRowCount()==1) {
					...
					try {
						...
						String sql = "DELETE FROM aluminiinfo_etrx where id = "+cell;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRowCount()==1)
				{
					...
					try {
						Class.forName("com.mysql.cj.jdbc.Driver");
						Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/miniproject","root","Bappamorya@1133");
						String query="Update aluminiinfo_etrx set Full_Name='"+name+"',Passout_Year='"+passyr+"',Number='"+phno+"',Email_Id='"+emlid+"' where Full_Name='"+name+"'";
		...
		btnShowData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String sql="Select * from aluminiinfo_etrx";
				...
				if(model.getRowCount()==0) {
					...
					try {
						...
						for(int i=0;i<model.getRowCount();i++) {
							...
							String query = "insert into aluminiinfo_etrx(Full_Name,Passout_Year,Number, Email_Id) values(?,?,?,?)";
		...
		frame12.getContentPane().add(panel_2);
